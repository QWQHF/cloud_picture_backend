package com.hf.cloudpicture.api.imagesearch.sub;
...
public class GetImageListApi {
    ...
    public static List<ImageSearchResult> getImageList(String url) {
        try {
            ...
            log.info("百度响应状态：{}", statusCode);
            log.info("百度响应内容：{}", body);
            ...
            log.error("获取图片列表失败，异常信息：{}", e.getMessage(), e);
